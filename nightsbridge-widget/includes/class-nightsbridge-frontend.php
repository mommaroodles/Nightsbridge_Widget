...
class Nightsbridge_Frontend {
    ...
    /**
     * Constructor to set up frontend hooks.
     */
    ...
    /**
     * Enqueue scripts and styles for the Nightsbridge widget on the selected page.
     */
    ...
    public function nb_apply_custom_styles() {
        try {
           ...
           document.addEventListener('DOMContentLoaded', function() {
            ...
            error_log( 'Error applying custom styles: ' . esc_html( $e->getMessage() ) );
